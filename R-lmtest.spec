...
Version  : 0.9.38
Release  : 82
URL      : https://cran.r-project.org/src/contrib/lmtest_0.9-38.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lmtest_0.9-38.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599848524
